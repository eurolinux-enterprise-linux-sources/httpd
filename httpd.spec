...
Source42:	httpd-spec_sl_index.html.sl7.patch
Source43:	httpd-sl_index.html.sl.patch
Source44:	httpd.ini
Source45:	httpd-eurolinux-index.patch
...
(cd $RPM_SOURCE_DIR; patch -p1 < httpd-sl_index.html.sl.patch; patch -p1 <httpd-eurolinux-index.patch)
...
* Wed Sep  4 2019 Aleksander Baranowski <aleksander.baranowski@euro-linux.com> 
- Pull from upstream:
...
* Tue Jul 30 2019 Cezary Drak <cd@euro-linux.com> 2.4.6.89.el7.1
- Resolves: #1719722 - CVE-2018-1312 httpd: Weak Digest auth nonce generation
  in mod_auth_digest

* Fri May  3 2019 Aleksander Baranowski <aleksander.baranowski@euro-linux.com>
- Rebuild for EuroLinux based on Scientific Linux Version
--> Change default index.html
--> Modify release string to note changes
- fix per-request leak of bucket brigade structure (#1583218)

* Wed Dec 12 2018 Aleksander Baranowski <aleksander.baranowski@euro-linux.com> 2.4.6.88
- Rebuild for EuroLinux based on Scientific Linux Version
--> Change default index.html
--> Modify release string to note changes
...
- Added Source: httpd-spec_sl_index.html.sl7.patch
